		...
		<div id="content">
			...
			<div id="right">
				...
				if (request.getAttribute("err") != null) {
					...
					tensp = (String) request.getAttribute("tensp");%>
					
					
				<% } %>
				
				<%if(productDAO.searchList(ten_san_pham, ten_the_loai).size()==0 && !ten_san_pham.equals("")) {%>
					
					<h3>Không tìm thấy sản phẩm nào phù hợp <%=ten_san_pham %></h3>
